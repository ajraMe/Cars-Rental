...
function Hero() {
    ...
    md:grid-cols-2'>
            ...
            font-bold '><span className='text-white'>Premium Cars</span> <br/><span
                    className='text-red-600'>Rental</span>
                ...
                <h2 className='text-[20px] text-gray-500 pr-20 mt-5 '>Book the selected car effortlessly, Pay for
                    driving only,
                    Book the Car Now
                </h2>
