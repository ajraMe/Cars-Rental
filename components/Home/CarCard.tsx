        ...
        <div
            ...
            <div className='flex justify-center'>
                {car?.image?.url ? (
                    ...
                    <div className='w-[250px] h-[150px] mb-3 flex items-center justify-center bg-gray-200'>
            ...
            <div className='flex justify-around group-hover:hidden'>
                ...
                <div className=' text-center text-gray-500 '>
                    <PiEngine className="w-full text-[22px] mb-2"/>
                    <h2 className='line-clamp-5 text-[14px] font-light'>{car.engine} Engine</h2>
                </div>
                <div className=' text-center text-gray-500 '>
                    <FaGasPump className="w-full text-[22px] mb-2"/>
                    <h2 className='line-clamp-5 text-[14px] font-light'>{car.liters} Liters</h2>
                </div>
            </div>
            <button className='hidden group-hover:flex bg-gradient-to-r
     from-blue-400 to-red-700
